...
public partial class administration_reports_Student_Detail : System.Web.UI.Page
{
    ...
    protected void LoadAllData(string studentid)
    {
        LoadStudentDetail(studentid);

        LoadEducationInfo(studentid);

        LoadDocumentInfo(studentid);
        LoadNotificationInfo(studentid);

    }

    protected void LoadStudentDetail(string studentid)
    {
        ...
        if (STEnt != null)
        {
            if (!string.IsNullOrEmpty(studentid))
            {
                ...
                imgfolder = Server.MapPath(@"~/images/bachelorstudent/") + studentid + ".jpg";
                if (File.Exists(imgfolder))
                {
                    imgStudent.ImageUrl = "~/images/bachelorstudent/" + studentid + ".jpg";
    ...
    protected void LoadEducationInfo(string studentid)
    {
        EDUEnt = new HSS_EDUCATION_DETAIL();
        EDUEnt.STUDENT_ID = studentid;
    ...
    protected void LoadDocumentInfo(string studentid)
    {
        ATTCEnt = new HSS_ATTACHMENTS();
        ATTCEnt.STUDENT_ID = studentid;
    ...
    protected void LoadNotificationInfo(string studentid)
    {

        INAEnt = new information_alert();
        INAEnt.STUDENTID = studentid;
