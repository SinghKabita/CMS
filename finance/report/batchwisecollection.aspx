<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="batchwisecollection.aspx.cs" Inherits="finance_report_batchwisecollection" %>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td style="text-align: left">
                                                    ...
                                                    ToolTip='<%# DataBinder.Eval(Container, "DataItem.BATCH")%>' OnClick="imgbtnClass_Click" />--%>
                                                Total Collection for Batch <b>
                                                    <%# DataBinder.Eval(Container, "DataItem.BATCH")%></b>
                                                </td>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td style="text-align: left">
                                                                        ...
                                                                        Total Collection for Semester <b>
