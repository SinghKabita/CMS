...
public partial class forms_student_info : System.Web.UI.Page
{
    ...
    public void LoadData(string STUDENT_ID)
    {
        ...
        if (SEnt != null)
        {
            lblpkid_hss_Std.Text = STUDENT_ID;
    ...
    protected void UpdateData(string STUDENT_ID)
    {
        DT = new DistributedTransaction();
        string filename = "";
        ...
        SEnt = new HSS_STUDENT();
        SEnt.STUDENT_ID = lblpkid_hss_Std.Text;
        SEnt = (HSS_STUDENT)SSer.GetSingle(SEnt);
        if (SEnt != null)
        {
            SEnt.NAME_ENGLISH = txtNAME_ENGLISH.Text;
        ...
        AEnt = new HSS_ATTACHMENTS();
        AEnt.STUDENT_ID = lblpkid_hss_Std.Text;
        AEnt = (HSS_ATTACHMENTS)ASer.GetSingle(AEnt);
        if (AEnt != null)
        {
            AEnt.PHOTO = chkPHOTO.Checked.ToString();
        ...
        if (DT.HAPPY == true)
        {
            ...
            LoadCollegeCode();
            Response.Redirect("~/administration/reports/studentlist.aspx?program=" + ddlProgram.SelectedValue);
        }
        else
        {
            DT.Abort();
