<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="student_info.aspx.cs"
    Inherits="forms_student_info" MaintainScrollPositionOnPostback="true" %>
            ...
            <div id="employee-detail" class="sub-container">
                ...
                <div class="row">
                    <label class="label col4">
                        <asp:Label ID="lblpkid_hss_Std" Text="" runat="server" Visible="true" />
                    </label>
                </div>
                <div class="row">
                    <label class="label col4">
