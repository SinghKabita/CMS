<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MakeUpMarkList.aspx.cs" Inherits="exam_report_MakeUpMarkList" %>
    ...
    <div class="container">
        ...
        <div id="div_print">
            <table style="width: 35%">
                ...
                <tr>
                    <td colspan="9" style="text-align: center">
                        <asp:Label ID="lblExamTypeP" runat="server" Style="font-family: 'Arial'; font-weight: 700; font-size: medium;"></asp:Label>
            ...
            <table style="width: 50%">
                <tr>
                    <td>
                        <asp:GridView ID="gridMakeupFailedStudent" AutoGenerateColumns="false"
                            OnRowDataBound="gridMakeupFailedStudent_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label Text='<%# Bind("MAKEUP") %>' ID="lblMakeUp" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
