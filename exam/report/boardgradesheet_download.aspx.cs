...
public partial class class_routine_reports_download_notes : System.Web.UI.Page
{
    ...
    Board_GradeSheet BGEnt = new Board_GradeSheet();
    Board_GradeSheetService BGSer = new Board_GradeSheetService();
    ...
    protected void LoadGallery()
    {
        ...
        BGEnt = new Board_GradeSheet();
        BGEnt.BATCH = ddlBatch.SelectedValue;
        BGEnt.SEMESTER = ddlSemester.SelectedValue;

        gridList.DataSource = BGSer.GetAll(BGEnt);
        gridList.DataBind();
