<%@ Page Language="C#" MaintainScrollPositionOnPostback="true"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OldMarksEntry.aspx.cs" Inherits="exam_internalexam_OldMarksEntry" %>
                    ...
                    <asp:GridView ID="grdMarksEntry" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Obtain Marks">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtObtainMarks" runat="server" 
                                        Width="40px" Height="22px" MaxLength="5"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
