<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OldMakeup_MarksEntry.aspx.cs" Inherits="exam_internalexam_OldMakeup_MarksEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="gridtable">
        ...
        <tr>
            <td>Batch</td>
            <td>
                <asp:DropDownList ID="ddlBatch" runat="server" Height="22px" OnSelectedIndexChanged="ddlBatch_SelectedIndexChanged" AutoPostBack="True"  Visible="true">
                </asp:DropDownList>
            </td>
    ...
    <table style="width: 100%">
        <tr>
            <td>
                ...
                <asp:GridView ID="grdMarksEntry" runat="server" AutoGenerateColumns="False" CssClass="gridtable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Obtain Marks">
                            <ItemTemplate>
                                <asp:TextBox ID="txtObtainMarks" runat="server" Text='<%# Bind("MAKEUP") %>' Width="40px" Height="22px" MaxLength="10"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Remarks">
                            <ItemTemplate>
                                <asp:RadioButtonList ID="rbtnRemarks" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="A">Absent</asp:ListItem>
                                    <asp:ListItem Value="E">Expel</asp:ListItem>
                                </asp:RadioButtonList>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
