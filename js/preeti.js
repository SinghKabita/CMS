function convert_to_unicode(texttoconvert)
{
//alert(texttoconvert);
...
var array_one_length = array_one.length ;
    ...
    var modified_substring = texttoconvert ;

//****************************************************************************************
//  Break the long text into small bunches of max. max_text_size  characters each.
//****************************************************************************************
    var text_size = texttoconvert.length ;
...
//**********************************************
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     { 
      ...
      while (texttoconvert.charAt ( sthiti2 ) != ' ') {sthiti2--;}
     } 
     else  { sthiti2 = text_size  ;  chale_chalo = 0 }
      
//   alert(" sthiti 1 = "+sthiti1); alert(" sthit 2 = "+sthiti2) 

     var modified_substring = texttoconvert.substring ( sthiti1, sthiti2 )  ;
